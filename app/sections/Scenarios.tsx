...
const stories = [
  {
    tag: "Consumer",
    who: "The one who almost forgot",
    quote: "It's 10am. It's her birthday. I remembered at breakfast.",
  ...
  {
    tag: "Diaspora",
    who: "The brother in Aberdeen",
    quote: "He passed his exams. I want to celebrate him properly — not just send cash.",
  ...
  {
    tag: "Corporate",
    who: "The HR manager who got her December back",
    quote: "200 staff. Christmas. One list. No hamper headaches.",
  ...
  return (
    <section id="stories" className="py-[120px] px-6 md:px-[52px]">
      <div className="max-w-[1080px] mx-auto">
        <RevealOnScroll>
          <SectionEyebrow text="Real Moments" />
          <h2
